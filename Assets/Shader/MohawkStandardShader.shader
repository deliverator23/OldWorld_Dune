Shader "Mohawk/StandardShader" {
	Properties {
		...
		[Header(Occlusion)] [SingleLineTexture(true)] _OcclusionMap ("Occlusion (R) Emmission(B)", 2D) = "white" {}
		...
		_EmissionColor ("Emisson Color", Vector) = (1,1,1,1)
		_EmissionIntensity ("Emisson Intensity", Float) = 1
